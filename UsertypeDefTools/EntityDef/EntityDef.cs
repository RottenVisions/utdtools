...
public class EntityDef
{
    ...
    void Reset(string content)
    {
        ...
        if (implements != null)
        {
            ...
            {
                if (item.NodeType == XmlNodeType.Comment || item.Name == "#comment") continue;
    ...
    public static void LoadFromFile(string dir)
    {
        ...
        {
            if (item.Name != "#comment" || item.NodeType != XmlNodeType.Comment)
            {
    ...
    void Save(string dir)
    {
        ...
        {
            var i = doc.CreateElement("Implements");
