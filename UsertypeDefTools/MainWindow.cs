...
namespace UsertypeDefTools
{
    public partial class MainWindow : Form
    {
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
			if( !m_isOpenProj )
			{
				MessageBox.Show("Please open the project first");
				return;
			}
        ...
        private void m_treeView_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (tn != null)
                {
                    ...
                    MenuItem newType = new MenuItem("New type");
                    newType.Click += new EventHandler(OnClick_CreateNewType);

                    MenuItem delType = new MenuItem("Delete type");
        ...
        private void OnClick_DeleteType(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Base type cannot be deleted");
                return;
            }
            ...
            if (referenecedBy != null)
                MessageBox.Show(string.Format("Unable to delete \n type &#39;{0}&#39; referenced by other type '{0}'", selectedType.Type, referenecedBy.Type));
            else
            {
        ...
        private void OnClick_DeleteEctityDef(object sender, EventArgs e)
        {
            ...
            if (entity != null)
            {
                if (MessageBox.Show(string.Format("Are you sure to delete the '{0}' entity?", entity.Name), "Delete", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
                {
